...
## Metodología
Lo primero será crear el archivo **schema.json** a partir del esquema de datos de la plataforma (_Catalogo de datos_) para ello se usará la siguiente herramienta: [Calculadora SDM Demostrador](https://portal.dsagro.uco.es/usescases/SDM/index.html).
