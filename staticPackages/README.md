...
Se crea el modelo de datos normalizado siguiendo el estándar [Smart Data Models](https://github.com/smart-data-models/dataModel.Agrifood). El punto de partida es la herramienta [Calculadora SDM]([https://smartservice.es/SDM/](https://portal.dsagro.uco.es/usescases/SDM/index.html)), que genera el `schema.json` a partir del esquema de la plataforma analítica.
